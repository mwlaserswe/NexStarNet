...
Module Matrix
    ...
    Public Function PolarKarthesisch(HourAngle As Double, Declination As Double) As Vector
        ...
        PolarKarthesisch.X = Math.Cos(-HourAngle) * Math.Cos(Declination)
        PolarKarthesisch.Y = Math.Sin(-HourAngle) * Math.Cos(Declination)
        PolarKarthesisch.z = Math.Sin(Declination)
    End Function
    ...
    Public Function LenghtVector(V As Vector) As Double
        LenghtVector = Math.Sqrt(V.X * V.X + V.Y * V.Y + V.z * V.z)
    End Function
